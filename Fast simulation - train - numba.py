...
plt.figure()
plt.hist(Time, histtype='stepfilled', color='white', edgecolor = 'blue', alpha=0.8, range=(200,1000), bins=500, label="Fast simulation")
plt.hist(Time_geant, histtype='stepfilled', color='white', edgecolor = 'red', alpha=0.8, range=(200,1000), bins=500, label = "Geant4")
plt.title('Time of photon tracks - Train 2')
plt.xlabel("Time (ns)")
plt.ylabel("Number of tracks")
plt.legend()
